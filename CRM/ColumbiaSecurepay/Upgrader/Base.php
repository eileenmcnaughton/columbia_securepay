 ...
 */
class CRM_ColumbiaSecurepay_Upgrader_Base {

  /**
   * @var CRM_ColumbiaSecurepay_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_ColumbiaSecurepay_Upgrader(
        'columbia_securepay',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_ColumbiaSecurepay_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_ColumbiaSecurepay_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
